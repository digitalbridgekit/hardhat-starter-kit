# Example to understand Chainlink Keepers, based on an auxiliary contract.
...
```bash
git clone -b keeper-simulation-w-contract https://github.com/digitalbridgekit/hardhat-starter-kit.git
